...
Shopware.Service('cmsService').registerCmsBlock({
    name: 'image-text-row-three',
    label: 'sw-cms.blocks.imageText.imageTextThree.label',
    category: 'text-image',
    component: 'sw-cms-block-image-text-row-two-three',
    previewComponent: 'sw-cms-preview-image-text-row-three',
    defaultConfig: {
        marginBottom: '20px',
        marginTop: '20px',
        marginLeft: '20px',
